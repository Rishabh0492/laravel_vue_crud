        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form v-on:submit="saveForm()">
                    ...
                    <div class="row">
                        <div class="col-xs-12 form-group">
                            <label class="control-label">Company test</label>
                            <input type="text" v-model="company.test" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 form-group">
                            <label class="control-label">Company testagain</label>
                            <input type="text" v-model="company.testagain" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 form-group">
